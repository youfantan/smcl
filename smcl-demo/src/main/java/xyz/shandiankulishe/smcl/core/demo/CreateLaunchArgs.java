...
public class CreateLaunchArgs {
    ...
    public String saveArgs(String LaunchArgs) throws IOException {
        File savedPath=new File("Property\\"+version+"\\"+"launchargs");
        FileUtils.write(savedPath,LaunchArgs,"UTF-8");
